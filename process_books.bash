...
cat intermediate_data/raw_word_counts.tsv | node get_dense_columns.js | ./rf_train_validate.R $unique_booktype > prediction/all_prediction.tsv 2> prediction/accuracy.tsv
