...
training_features <- subset(modeled_features, modeled_features$rowgroup > .1)
test_features <- subset(modeled_features, modeled_features$rowgroup <= .1)
